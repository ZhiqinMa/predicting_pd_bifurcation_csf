...
Requires Python 3.8 or later to compute early warning signals (EWS). To install python package dependencies, use the command

```bash
conda create ewstools_deac python=3.8
conda activate ewstools_deac
pip install -r requirements_ewstools_deac.txt
```
