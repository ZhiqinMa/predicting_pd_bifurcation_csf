...
for tsid in list_tsid:
    ...
    # Compute EWS
    ts = ewstools_user.TimeSeries(s, transition=transition)
...
print("---------- Successful Compute EWS in chick heart data ----------")
