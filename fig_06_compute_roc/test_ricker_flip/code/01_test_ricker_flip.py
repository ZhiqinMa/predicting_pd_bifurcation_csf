...
import funs_ricker_flip as funs
...
rof_vals = [1.5/500, 1.5/400, 1.5/300, 1.5/200, 1.5/100]
...
print("---------- Successful Test DL classifier and EWS on Ricker_flip model: test_ricker_flip ----------")
