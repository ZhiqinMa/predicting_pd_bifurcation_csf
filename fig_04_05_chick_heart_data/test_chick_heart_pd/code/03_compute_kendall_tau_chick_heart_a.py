...
for tsid in list_tsid:
    ...
    ts.compute_de(rolling_window=rw, lags=5, user_model='discrete_exp_decay')
...
# Export data
df_ktau_forced.to_csv('../output/data/df_ktau_pd_fixed_sub_a.csv', index=False)
df_ktau_null.to_csv('../output/data/df_ktau_null_fixed_sub_a.csv', index=False)
