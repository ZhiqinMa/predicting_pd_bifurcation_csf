...
# Heart data
# --------
df_roc = pd.read_csv("../output/data/df_roc_sub_b.csv")
...
fig_roc.write_image("../output/figures/fig5_roc_sub_b.pdf", scale=scale)
fig_roc.write_image("../output/figures/fig5_roc_sub_b.png", scale=scale)
